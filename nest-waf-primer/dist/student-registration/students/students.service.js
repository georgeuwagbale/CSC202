...
let StudentsService = class StudentsService {
    ...
    createStudent() {
        return { "modeOfEntry": studentRegistration_types_1.ModeOfEntry, "Gender": studentRegistration_types_1.Gender, "users": user_entity_1.User };
    }
    async findAll() {
    ...
    async setUserById(studentId, userId) {
        try {
            return await this.studentRepository.createQueryBuilder().relation(student_entity_1.Student, "user").of(studentId).set(userId);
        }
        catch (error) {
    ...
    async unsetUserById(studentId) {
        try {
            return await this.studentRepository.createQueryBuilder().relation(student_entity_1.Student, 'user')
